...
def get_output_dir(base_results_path="results/positive-meme-detection"):
    """
...
def process_image_folder(analyzer, base_folder, output_folder, batch_size=4):
    ...
    if not image_paths:
        print(
            f"No images found in {base_folder}/[positive|negative]. Please add images and try again."
        )
        return
...
if __name__ == "__main__":
    ...
    # Dataset path
    TARGET_FOLDER = "dataset/sample-cultural-meme-detector"
    BATCH_SIZE = 4
